...
public class PutMethodUsingGoogleHttpClientTest {

    @Test(priority = 1)
    public void putMethodUsingGoogleHttpClient(){
        ...
        try {
            ...
            request = transport.createRequestFactory().buildPutRequest(url, content);
