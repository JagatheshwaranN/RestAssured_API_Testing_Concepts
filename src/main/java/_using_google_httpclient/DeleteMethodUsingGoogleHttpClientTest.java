...
public class DeleteMethodUsingGoogleHttpClientTest {

    @Test(priority = 1)
    public void deleteMethodUsingGoogleHttpClient(){
        ...
        try {
            ...
            request = transport.createRequestFactory().buildDeleteRequest(url);
